# YDB-Importer - Импорт данных из источников JDBC в базы данных YDB

Эта утилита реализует функцию импорта структуры таблиц и содержащихся в таблицах записей из источников JDBC в базы данных YDB.
