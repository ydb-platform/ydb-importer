...
public class MariaDbTableLister extends MySqlTableLister {
    ...
    protected void grabColumnTypes(Connection con, TableDecision td, TableMetadata tm)
        ...
        // MariaDB JDBC driver reports large blob types as Types.VARBINARY via
        // ResultSetMetaData, so isBlob() misses them and a value up to 4 GB
        // would be imported inline, breaking the YDB row-size limit.
        // TINYBLOB (255 B) and BLOB (64 KB) fit inline safely.
        try (PreparedStatement ps = con.prepareStatement(
