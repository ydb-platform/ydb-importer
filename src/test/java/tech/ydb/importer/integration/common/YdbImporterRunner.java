...
/**
 * Assembles an {@link ImporterConfig} from minimal parameters and runs the
 * {@link YdbImporter} in-process.
 */
public final class YdbImporterRunner {
    ...
    public static final class Builder {
        ...
        public Builder readerPoolSize(int value) {
            this.readerPoolSize = value;
            return this;
        }
        ...
        public Builder clobColumns(String... columns) {
        ...
        public ImporterConfig buildConfig() {
            ...
            workers.setReaderPoolSize(readerPoolSize);
