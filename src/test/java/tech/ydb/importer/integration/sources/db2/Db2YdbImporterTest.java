...
public class Db2YdbImporterTest {
    ...
    abstract class Db2TypeCases extends AbstractYdbImporterTypeTest {
        ...
        public void timeMapsToInt32() throws Exception {
            // Db2 TIME has only second precision (no fractional component).
            typeTest().withArrow(useArrow())
        ...
        public void timestampDefaultMaps() throws Exception {
            /*
             * Default TIMESTAMP has fractional precision 6. Scale>0 picks
             * Timestamp64. YDB Timestamp64 returns Instant via SDK.
             */
            typeTest().withArrow(useArrow())
        ...
        public void timestampZeroMaps() throws Exception {
            /*
             * TIMESTAMP(0) reports scale=0 -> Datetime64. YDB SDK returns
             * LocalDateTime for Datetime64.
             */
            typeTest().withArrow(useArrow())
