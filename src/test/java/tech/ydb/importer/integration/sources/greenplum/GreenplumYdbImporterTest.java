...
/**
 * Greenplum integration tests. Reuses Postgres-compatible type and table cases.
 */
public class GreenplumYdbImporterTest {
    ...
    abstract class GreenplumTableCases
         ...
         * pk_over_unique uses a composite PK, uq_fewer_cols changes its
         * second UNIQUE to include the distribution column.
         */
        @Test
        @Override
